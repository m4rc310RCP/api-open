package br.com.m4rc310.auth.messages;
...
public class MMessageBuilder {
	...
	@Value("${m4rc310.graphql.constants.path}")
	private String constPath;
	
	/** The classname. */
	@Value("${m4rc310.graphql.constants.classname:br.com.m4rc310.auth.constants.MConst}")
